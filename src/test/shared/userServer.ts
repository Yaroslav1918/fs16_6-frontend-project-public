...
export const handlers = [
  rest.post(
    "https://ecommerce-api-3946fddfdbf1.herokuapp.com/users/signup",
    async (req, res, ctx) => {
  ...
  rest.get(
    "https://ecommerce-api-3946fddfdbf1.herokuapp.com/users",
    (req, res, ctx) => {
      return res(ctx.json(usersData));
    }
  ),
  rest.put(
    "https://ecommerce-api-3946fddfdbf1.herokuapp.com/users/:_id",
    async (req, res, ctx) => {
  ...
  rest.post(
    "https://ecommerce-api-3946fddfdbf1.herokuapp.com/users/login",
    async (req, res, ctx) => {
